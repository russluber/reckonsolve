...
Status: v0.3 source release complete; v0.4 implemented through Milestone 29
...
| Domain and application operations | Complete v0.3 workflows plus M26 terminal-history reads and atomic correction/completion operations; M27 exposes Resolution and Invalid-reason correction while Postmortem completion remains UI-hidden until M30; M28 and M29 add read-only scorecard and paired-update projections |
...
| Automated tests | Complete v0.1-v0.3 coverage plus M26-M28 correction and scorecard coverage and M29 pure, persistence, correction, filtering, exact-unit, and real-database Qt coverage for one-pair update analytics |
