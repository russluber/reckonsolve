...
| Domain and application operations | Complete v0.3 workflows plus terminal-history reads and atomic correction/completion operations, read-only scorecard and paired-update projections, Needs Postmortem, historically complete CLI rendering, and verified v0.4 transfer operations |
...
| Automated tests | Complete v0.1-v0.3 coverage plus v0.4 correction, scorecard, update-analytics, queue, CLI-read, format-version-three export, migration, recovery, concurrency, and frozen-build smoke coverage |
