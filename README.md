...
- [Product specification](docs/product-spec.md) — implemented v0.1 through v0.4 behavior plus the authorized v0.5 contract, milestones, and acceptance criteria
